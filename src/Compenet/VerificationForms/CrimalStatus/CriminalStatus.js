...
import { Container,FormikForm2, FormField,FormLabel,
    ...
    import { criminalStatus } from '../../../store/External/Actions/FormActions';
    ...
    return (
        ...
        onSubmit={(values => {
          ...
          render={({
            ...
            <FormikForm2>
                    <SubTitle>
                    <SubTitleText>Criminal Checks</SubTitleText>
                    <Rule />
                    </SubTitle>
                {/* <FormField>
