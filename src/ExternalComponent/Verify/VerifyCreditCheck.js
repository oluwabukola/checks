...
import { VerifyCredit } from '../../store/LinkedInfo/Actions/verificationAction';
...
const VerifyCreditCheck = ({show, handleClose, credit}) => {
    const dispatch = useDispatch();
    const [verified, setVerified] = useState(credit);
    console.log('verifieddd  credit check', verified);
   ...
   const  handleVerification = async (event) => {
       ...
       const Id =  verified.employee_id;
        ...
        dispatch(VerifyCredit(creditCheck, Id))
...
export default VerifyCreditCheck;
