...
import { VerifyEducational} from '../../store/LinkedInfo/Actions/verificationAction';
...
const VerifyEducationCheck = ({show, handleClose, edu}) => {
    const dispatch = useDispatch();
    const [verified, setVerified] = useState(edu);
   ...
   const  handleVerification = async (event) => {
       ...
       const Id =  verified.employee_id;
        ...
        dispatch(VerifyEducational(educationCheck, Id))
...
export default VerifyEducationCheck;
