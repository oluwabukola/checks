...
import { VerifyGuarantors } from '../../store/LinkedInfo/Actions/verificationAction';
...
const VerifyGuarantor = ({show, handleClose, x}) => {
    const dispatch = useDispatch();
    const [verified, setVerified] = useState(x);
    console.log('verifieddd guarantor', verified);
   ...
   const  handleVerification = async (event) => {
       ...
       const Id =  verified.employee_id;
        ...
        dispatch(VerifyGuarantors(guarantor, Id))
